...
## PASS v0.3.1 Rene L. Warren, 2015-2024
...
It is derived from the de novo genome assembler SSAKE, an easy-to-use, robust and tractable sequence assembly algorithm for very short nucleic acid sequencing reads, such as those generated by Illumina Ltd. 
...
PASS Copyright (c) 2015-2024 Rene Warren.  All rights reserved.
